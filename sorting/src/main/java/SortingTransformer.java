        ...
        try (InputStream stream = SortingTransformer.class.getResourceAsStream(path)) {
            ...
            Collections.sort(nodes, new Comparator<Element>() {
                ...
                public int compare(Element e1, Element e2) {
                    double score1=Double.valueOf(e1.getElementsByTagName("score").item(0).getTextContent());
                    double score2=Double.valueOf(e2.getElementsByTagName("score").item(0).getTextContent());
                    if(score1 > score2){
                        return 1;
